    ...
    MediumEditor.prototype = {
        ...
        buttonTemplate: function(btnType) {
            var buttonTemplates = {
                ...
                'quote': '<li><button class="medium-editor-action medium-editor-action-quote" data-action="append-blockquote" data-element="blockquote"><i class="fa fa-quote-right"></i></button></li>',
